...
const labels: Record<string, string> = {
  ...
  source_url: "URL nguồn", source_publisher: "Nhà xuất bản", source_note: "Ghi chú nguồn", author_name: "Tác giả",
...
const nums = new Set(["session_count", "session_duration_minutes", "price", "original_price", "display_order"]);
...
export function AdminEditor({ section, id, record, error }: { section: EditorSection; id: string; record: Record<string, unknown> | null; error?: string }) {
