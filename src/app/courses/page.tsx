...
export const metadata: Metadata = createPageMetadata({ title: "Các khóa học", description: "Khám phá các khóa học tiếng Trung và chương trình phát triển năng lực tại Vũ Thịnh.", path: "/courses" });
