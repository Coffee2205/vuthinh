    ...
    <section className="bg-slate-50 py-10 sm:py-14 lg:py-16">
      <Container>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-start">
          <div className="relative aspect-[16/10] overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 via-white to-emerald-100">
            {course.thumbnailUrl ? (
              <Image
              ...
              <div className="grid h-full place-items-center p-8 text-center text-lg font-extrabold uppercase tracking-[0.18em] text-brand-blue">
                Vũ Thịnh · Chương trình học
              </div>
            )}
          </div>
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.14em] text-brand-blue">
              {course.category.program.name} · {course.category.name}
            </p>
            ...
            <dl className="mt-6 grid grid-cols-2 gap-4 rounded-2xl border border-slate-200 bg-white p-5 text-sm">
              ...
              {course.classSizeText && (
                <div>
                  <dt className="text-slate-500">Sĩ số</dt>
                  <dd className="mt-1 font-bold text-slate-900">
                    {course.classSizeText}
                  </dd>
                </div>
            ...
            <div className="mt-6">
              ...
              <CoursePrice course={course} large />
            </div>
            <Link
