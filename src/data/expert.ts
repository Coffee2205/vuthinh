...
export const lecturerProfile = {
  ...
  shortBio: "Giảng viên Huỳnh Anh Ngữ, tên thường gọi là Vũ Thịnh, có nhiều năm kinh nghiệm trong giảng dạy, đào tạo, huấn luyện tiếng Trung và xây dựng hoạt động kinh doanh, đào tạo trong và ngoài nước.",
  biography: [
  ...
  teachingAreas: ["Tiếng Trung", "Định hướng học tập", "Kỹ năng sống và cảm xúc", "Đào tạo và huấn luyện"],
} as const;
