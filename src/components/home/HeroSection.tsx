...
export function HeroSection() {
  return (
    <section className="site-hero-image relative isolate overflow-hidden bg-brand-blue-soft py-16 sm:py-20 lg:py-24">
      ...
      />
      <div
        className="absolute inset-0 -z-10 bg-gradient-to-r from-[#241B2B]/95 via-[#3D3242]/82 to-[#3D3242]/20"
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 -z-10 bg-gradient-to-t from-[#241B2B]/45 via-transparent to-black/10"
        aria-hidden="true"
      />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-sm leading-6 text-white/65">
              Chọn chương trình phù hợp với độ tuổi, mục tiêu và nhịp học của
              bạn.
            </p>
          </div>
          ...
          <div
            ...
            aria-label="Các lĩnh vực giáo dục trọng tâm"
          >
            <div
              className="absolute inset-5 -rotate-3 rounded-[2rem] bg-brand-blue/10"
              aria-hidden="true"
            />
            <div className="relative rounded-[2rem] border border-white/80 bg-white/90 p-5 shadow-[0_24px_70px_-35px_rgba(23,105,170,0.5)] backdrop-blur sm:p-7">
              <div className="flex items-center justify-between border-b border-slate-100 pb-5">
                <div>
                  ...
                  <p className="mt-1 text-xl font-bold text-slate-950">
                    Trí tuệ · Ngôn ngữ · Kỹ năng sống
                  </p>
                </div>
                <div
                  className="grid size-14 shrink-0 place-items-center rounded-2xl bg-brand-blue text-2xl font-bold text-white"
                  aria-hidden="true"
                >
                  学
                </div>
              ...
              <div className="mt-5 grid gap-4">
                {heroContent.focusAreas.map((area) => (
                  ...
                  >
                    <p
                      className={`text-xs font-bold uppercase tracking-[0.14em] ${area.tone === "blue" ? "text-brand-blue" : "text-brand-green"}`}
                    >
                      {area.label}
                    </p>
