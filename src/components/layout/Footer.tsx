  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50">
      <Container className="grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-3">
        <div><Logo variant="wordmark" /><p className="mt-3 max-w-sm text-sm leading-6 text-slate-600">Hệ sinh thái giáo dục gia đình kết hợp ngôn ngữ, kỹ năng sống và phát triển con người.</p></div>
        <div><h2 className="font-semibold text-slate-900">Liên kết nhanh</h2><div className="mt-3 flex flex-col gap-2 text-sm text-slate-600"><Link className="hover:text-brand-blue" href="/courses">Khóa học</Link><Link className="hover:text-brand-blue" href="/expert">Giảng viên</Link><Link className="hover:text-brand-blue" href="/contact">Liên hệ</Link></div></div>
